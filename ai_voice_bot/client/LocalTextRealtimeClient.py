...
class RealtimeClient:
    ...
    def __init__(
        ...
        on_audio_transcript_delta: Optional[Callable[[Dict[str, Any]], None]] = None,
    ...
    def get_defining_class(self, method_name='on_audio_transcript_delta'):
        """Helper function to get the class where a method is defined."""
        for cls in type(self).__mro__:
            if method_name in cls.__dict__:
                return cls.__name__
        return None
    def on_audio_transcript_delta(self, event: Dict[str, Any]) -> None: 
    ...
    async def stream_audio(self, audio_chunk: bytes) -> None:
        ...
        await self.local_transcribe(audio_chunk)
    async def local_transcribe(self,audio_chunk) -> None:
        print('local_transcribe', len(audio_chunk))
    ...
    async def _call_tool(self, call_id: str,tool_name: str, tool_arguments: Dict[str, Any]) -> None:
    ...
    async def handle_event(self, event_type):
        ...
        if event_type == "input_audio_buffer.speech_started":
            print("[Mock Client 000] Handling speech started event.")
            pass
